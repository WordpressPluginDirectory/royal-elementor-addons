			...
			$('.elementor-element--promotion').on('click', function() {
				...
				if ( $(this).find('.wpr-icon').length ) {
					...
					var url = '',
						...
						dialogueMessage = 'Advanced Filters lets you filter by <b>Colors, Brands, Ratings, Price Range</b>, or any custom meta field. It also supports <b>Custom Post Types (CPT)</b>, and you can create dynamic dependent dropdowns for a faster, more intuitive browsing experience.',
